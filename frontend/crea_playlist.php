            ...
            <div class="nav-section">
                ...
                <ul>
                    <?php foreach ($playlist_utente as $pl): ?>
                        <li><a href="#"><i class="fas fa-headphones"></i> <?php echo htmlspecialchars($pl['nome']); ?></a>
                        </li>
                    <?php endforeach; ?>
                    <li><a href="crea_playlist.php" class="active"><i class="fas fa-plus-circle"></i> Crea Playlist</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="form-container">
                    ...
                    <form method="POST" action="">
                        <div class="form-group">
                            ...
                            <input type="text" id="nome" name="nome" placeholder="Es. Le mie canzoni preferite"
